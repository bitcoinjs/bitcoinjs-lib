...
describe('bitcoinjs-lib (transactions)', function () {
  ...
  it('can create a 2-to-2 Transaction', function () {
    ...
    // prepare for broadcast to the Bitcoin network, see "can broadcast via 3PBP" below
  ...
  // CAUTION: if you don't understand what this example is for, don't do it
  it('can sign a Transaction with something other than ECPair', function () {
    const txb = new bitcoin.TransactionBuilder()
