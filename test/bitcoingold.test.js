...
describe('TransactionBuilder', function () {
    ...
    it('goldtestcase_multisig_1', function () {
        ...
        var wif1 = 'L54PmHcjKXi8H6v9cLAJ7DgGJFDpaFpR2YsV2WARieb82dz3QAfr'
        var wif2 = 'L54PmHcjKXi8H6v9cLAJ7DgGJFDpaFpR2YsV2WARieb82dz3QAfr'
        var keyPair1 = ECPair.fromWIF(wif1, network)
        var keyPair2 = ECPair.fromWIF(wif2, network)

        var script = bscript.multisig.output.encode(2, [keyPair1.getPublicKeyBuffer(), keyPair2.getPublicKeyBuffer()])
        var scriptHash = bcrypto.hash160(script);
        var spk = bscript.scriptHash.output.encode(scriptHash)
