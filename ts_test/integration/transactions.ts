...
describe('bitcoinjs-lib (transactions)', () => {
  it('can create a 1-to-1 Transaction', () => {
    ...
    assert.strictEqual(
      txb.build().toHex(),
      '01000000019d344070eac3fe6e394a16d06d7704a7d5c0a10eb2a2c16bc98842b7cc20' +
  ...
  it('can create a 2-to-2 Transaction', () => {
    ...
    assert.strictEqual(
      txb.build().toHex(),
      '01000000024c94e48a870b85f41228d33cf25213dfcc8dd796e7211ed6b1f9a014809d' +
  ...
  it('can verify Transaction (P2PKH) signatures', () => {
    const txHex =
      '010000000321c5f7e7bc98b3feda84aad36a5c99a02bcb8823a2f3eccbcd5da209698b' +
  ...
  it('can verify Transaction (P2SH(P2WPKH)) signatures', () => {
    ...
    const txHex =
      '02000000000101090159b191bb5e562877bb4bf4b54a8405a95615751514d0edfc40ac' +
